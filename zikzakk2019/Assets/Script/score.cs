...
public class score : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Score = 0;
        lastScoreColore = 0;
        wheel = PlayerPrefs.GetInt("wheelsScore.CS", wheel);
    ...
    void Update()
    {
        ...
        if (PlayerObj != null)
        {
            ...
            PlayerPrefs.SetInt("wheelsScore.CS", TopMovement.instance.wheel);
            PlayerPrefs.Save();


            wheelText2.text = TopMovement.instance.wheel.ToString();
        }
        else
        {
